...
const EditView = ({
  ...
  const allowedActions = {...actionsAllowed};
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        ...
        setActions({
          canDelete: findOption?.excluir,
          canUpdate: findOption?.editar,
          canCreate:findOption?.criar,
        })
        allowedActions.canDelete = findOption?.excluir;
        allowedActions.canUpdate = findOption?.editar;
